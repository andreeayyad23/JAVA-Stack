...
<div class="container">
            ...
            <c:forEach var="burger" items="${burgers}">
                <tr>
                    <td><c:out value="${burger.burgerName}"/></td>
 					...
 					<td><a href="/burger/${burger.id}" class="btn btn-primary btn-sm"><c:out value="${burger.resturentName}"/></a></td>
                    <td><c:out value="${burger.rating}"/></td>
                    <td>
                        <div class="btn-group" role="group">
                            <a href="/burger/edit/${burger.id}" class="btn btn-primary btn-sm">Edit</a>
    ...
    <form:form action="/burgers" method="POST" modelAttribute="burger" class="mb-5">
        <div class="mb-3">
