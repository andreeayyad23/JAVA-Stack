...
public class Test {
    ...
    public static void main(String[] args) {
        // Creating instances of Physician and AdminUser
        ...
        String authTest4 = roseTyler.accessAuthorized(2) ? "PASS" : "FAIL";
        System.out.printf("Admin auth test 2: %s\n", authTest4);

        // Simulating security incidents for AdminUser donnaNoble
